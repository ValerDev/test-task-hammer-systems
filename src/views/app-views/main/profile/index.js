...
const Profile = (props) => {
    const {match: {params: {id}}, currentClient} = props
    ...
    useEffect(async () => {
        const data = await fetchCurrentClient(props.fetchCurrentClient, id)
    }, [])
...
const mapDispatchToProps = dispatch => {
    return {
        fetchCurrentClient: clients => dispatch(currentClientAC(clients))
    }
}
